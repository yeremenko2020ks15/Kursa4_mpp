...
class OrderDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create order_detail" do
    assert_difference('OrderDetail.count') do
      post order_details_url, params: { order_detail: { cart_item_id: @order_detail.cart_item_id, completed: @order_detail.completed, payment_id: @order_detail.payment_id, payment_type_id: @order_detail.payment_type_id, rejection: @order_detail.rejection, user_id: @order_detail.user_id } }
    end
  ...
  test "should update order_detail" do
    patch order_detail_url(@order_detail), params: { order_detail: { cart_item_id: @order_detail.cart_item_id, completed: @order_detail.completed, payment_id: @order_detail.payment_id, payment_type_id: @order_detail.payment_type_id, rejection: @order_detail.rejection, user_id: @order_detail.user_id } }
