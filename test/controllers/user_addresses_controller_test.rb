...
class UserAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_address" do
    assert_difference('UserAddress.count') do
      post user_addresses_url, params: { user_address: { address_street: @user_address.address_street, city: @user_address.city, house_num: @user_address.house_num, postal_code: @user_address.postal_code, state: @user_address.state, user_id: @user_address.user_id } }
    end
  ...
  test "should update user_address" do
    patch user_address_url(@user_address), params: { user_address: { address_street: @user_address.address_street, city: @user_address.city, house_num: @user_address.house_num, postal_code: @user_address.postal_code, state: @user_address.state, user_id: @user_address.user_id } }
