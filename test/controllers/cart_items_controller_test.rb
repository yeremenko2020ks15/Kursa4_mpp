...
class CartItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post cart_items_url, params: { cart_item: { product_id: @cart_item.product_id, quantity: @cart_item.quantity, shopping_session_id: @cart_item.shopping_session_id, total: @cart_item.total } }
    end
  ...
  test "should update cart_item" do
    patch cart_item_url(@cart_item), params: { cart_item: { product_id: @cart_item.product_id, quantity: @cart_item.quantity, shopping_session_id: @cart_item.shopping_session_id, total: @cart_item.total } }
